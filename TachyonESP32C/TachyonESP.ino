...
reboot - fix
mask
character & ctrl literals 'a' ^a etc
...
( Better Errors )
variable errors
: .ERROR	plain bold red pen ."  *ERROR* " flushkeys errors ++ ;
: notfound ( a n n -- )
...
: aprompt    plain blue pen  depth str type 35 emit 62 emit space plain  ;
...
: refill   		prompt  tib-setup tib input-limit  accept  #tib ! >in ~ -1 ;
